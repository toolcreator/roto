...
describe('Band list', () => {
  ...
  it('changes a bandname and calls back if it should', () => {
    ...
    expect(toChangeLi.innerHTML.includes(oldName)).to.equal(true);
  ...
  it('adds a band and calls back if it should', () => {
    ...
    expect(bandLi0.innerHTML.includes(names[0])).to.equal(true);
    ...
    expect(bandLi1.innerHTML.includes(names[1])).to.equal(true);
  ...
  it('removes a band and calls back if it should', () => {
    ...
    expect(bandLi0).to.not.equal(null);
    expect(bandLi0.innerHTML.includes(name0)).to.equal(true);
    ...
    expect(bandLi1).to.not.equal(null);
    expect(bandLi1.innerHTML.includes(name1)).to.equal(true);
